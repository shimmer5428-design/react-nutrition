...
export const BUILTIN_FOODS: FoodItem[] = [
  // ── Protein ──
  { name: '雞蛋', amount: 1, unit: '顆', protein_g: 8.0, carbs_g: 1.0, fat_g: 5.0, calories: 78.0, category: 'protein' },
  ...
  { name: '豆漿（無糖）', amount: 240, unit: 'ml', protein_g: 7.0, carbs_g: 8.0, fat_g: 4.0, calories: 100.0, category: 'protein' },
  ...
  { name: '牛奶（全脂）', amount: 240, unit: 'ml', protein_g: 8.0, carbs_g: 12.0, fat_g: 8.0, calories: 149.0, category: 'protein' },
  { name: '牛奶（脫脂）', amount: 240, unit: 'ml', protein_g: 8.0, carbs_g: 12.0, fat_g: 0.0, calories: 83.0, category: 'protein' },
  { name: '水煮鮪魚罐頭', amount: 150, unit: 'g', protein_g: 22.1, carbs_g: 0.0, fat_g: 5.4, calories: 138.0, category: 'protein' },
  ...
  { name: '全麥吐司', amount: 30, unit: '片', protein_g: 3.0, carbs_g: 14.0, fat_g: 1.0, calories: 77.0, category: 'starch' },
  ...
  // ── Fat ──
  { name: '橄欖油', amount: 15, unit: 'ml', protein_g: 0.0, carbs_g: 0.0, fat_g: 14.0, calories: 120.0, category: 'fat' },
  { name: '椰子油', amount: 15, unit: 'ml', protein_g: 0.0, carbs_g: 0.0, fat_g: 14.0, calories: 120.0, category: 'fat' },
  ...
  { name: '芝麻油', amount: 15, unit: 'ml', protein_g: 0.0, carbs_g: 0.0, fat_g: 14.0, calories: 120.0, category: 'fat' },
  { name: '亞麻仁油', amount: 15, unit: 'ml', protein_g: 0.0, carbs_g: 0.0, fat_g: 14.0, calories: 120.0, category: 'fat' },
  ...
  { name: '巧克力蛋糕', amount: 100, unit: 'g', protein_g: 4.7, carbs_g: 40.2, fat_g: 30.4, calories: 450.0, category: 'dessert' },
  { name: '檸檬塔', amount: 1, unit: '份', protein_g: 4.5, carbs_g: 31.6, fat_g: 13.6, calories: 260.0, category: 'dessert' },
  { name: '香草冰淇淋', amount: 100, unit: 'g', protein_g: 3.5, carbs_g: 24.0, fat_g: 11.0, calories: 210.0, category: 'dessert' },
  { name: '糖霜甜甜圈', amount: 1, unit: '個', protein_g: 2.0, carbs_g: 25.0, fat_g: 12.0, calories: 220.0, category: 'dessert' },
  { name: '費南雪', amount: 1, unit: '個', protein_g: 2.5, carbs_g: 15.0, fat_g: 10.0, calories: 150.0, category: 'dessert' },
  { name: '蛋黃酥', amount: 1, unit: '個', protein_g: 6.0, carbs_g: 30.0, fat_g: 22.0, calories: 342.0, category: 'dessert' },
  { name: '餅乾', amount: 1, unit: '個', protein_g: 1.0, carbs_g: 10.0, fat_g: 5.0, calories: 90.0, category: 'dessert' },
  { name: '布丁', amount: 1, unit: '份', protein_g: 5.0, carbs_g: 12.0, fat_g: 9.8, calories: 158.0, category: 'dessert' },
